...
import { Activity, Archive, ArrowDownToLine, ArrowUpRight, Bell, BookOpen, Check, ChevronDown, CircleHelp, FilePlus2, FileJson, FileText, Filter, FolderKanban, Grid2X2, History, Image as ImageIcon, LayoutDashboard, MessageCircle, MoreHorizontal, Plus, Search, Settings, ShieldCheck, Sparkles, Users, X } from 'lucide-react'
import {
  createNote,
...
function App({ session, organizationId, organizationName, role }: { session: Session; organizationId: string; organizationName: string; role: Membership['role'] }) {
  ...
  const isProjectView = activeNav !== 'Equipe' && activeNav !== 'Configurações' && activeNav !== 'Visão geral'
