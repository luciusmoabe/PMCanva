...
9. Real envio de e-mail para convites (via Supabase Edge Function + servico de e-mail) e recuperacao de senha/MFA — melhorias de qualidade de vida que nao bloqueiam o uso interno do app, mas bloqueiam abrir para usuarios externos de verdade.
