...
11. Real envio de e-mail para convites (via Supabase Edge Function + servico de e-mail) — melhoria de qualidade de vida que nao bloqueia o uso interno do app, mas bloqueia abrir para usuarios externos de verdade.
